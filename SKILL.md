...
description: Systematic codebase entropy reduction — identifies and fixes structural, semantic, behavioral, and evolutionary disorder in codebases. Use when refactoring, cleaning up tech debt, improving code consistency, reducing complexity, making a codebase more maintainable, or when the user mentions entropy, code quality, code health, or asks to "clean up" or "simplify" a module, directory, or entire repo. Especially valuable for AI-first and vibe coding teams where code accumulates disorder quickly.
---
