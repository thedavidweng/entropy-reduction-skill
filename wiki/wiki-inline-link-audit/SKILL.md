...
- **Batch-fix patterns**: Large groups of pages with identical unlinked terms (e.g., 100+ person pages all missing `[[example-high-school]]`). Safe to auto-fix.
...
## Flight Export CSV Import

When importing flight export CSV:
...
Airport codes should link to place pages where they exist (e.g., `[[new-york|New York]]` for JFK). Cities without place pages remain plain text.
