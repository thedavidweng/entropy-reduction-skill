...
- [ ] Update `.claude-plugin/plugin.json` if the skill should appear in the default install menu
...
- [ ] Run `npx skills add user/repo --list` to confirm default-menu skills are discoverable
